// Purchase Order Transaction Component for Tiny-ERP
// Standalone transaction screen for purchase order management

Vue.component('purchase-order-transaction', {
  ...
  data() {
    return {
      ...
      validationRules: {
        ...
        expectedDeliveryDate: { required: true },
        locationId: { required: true }
      },
      statusOptions: [
        { value: 'draft', text: 'Draft' },
        { value: 'ordered', text: 'Ordered' },
        { value: 'partial', text: 'Partially Received' },
  ...
  methods: {
    ...
    // Load master data (suppliers, locations, items)
    ...
    addItem() {
      ...
      if (existingItemIndex >= 0) {
        ...
        // Add new item
        const unitPrice = this.newItem.unitPrice > 0 ? this.newItem.unitPrice : item.costPrice;
        const total = this.newItem.quantity * unitPrice;
        const taxAmount = (total * item.taxRate) / 100;
        
        this.entity.items.push({
          id: TinyERPHelpers.generateId('POI'),
          itemId: item.id,
          itemName: item.name,
    ...
    <div>
      ...
      >
        ...
        <template v-slot:form>
          <form-section title="Purchase Order Information">
            <form-row>
              <form-col size="6">
                <form-select
            ...
            <form-row>
              ...
              <form-col size="4">
                <form-date
                  v-model="entity.expectedDeliveryDate"
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-md-2">
                      <form-input
                        ...
                        min="0"
                        step="0.01"
                        :placeholder="selectedItem ? selectedItem.costPrice : ''"
                      ></form-input>
                    </div>
